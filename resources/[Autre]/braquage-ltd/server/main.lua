...
lib.callback.register('braquage_superette:registerSuccessful', function(source, verifyReward)
    local source = source
...
lib.callback.register('braquage_superette:safeSuccessful', function(source, verifyReward)
    local source = source
    local player = GetPlayer(source)
    local playerName = GetName(source)
    local playerId = player.source or player.PlayerData.source
...
RegisterNetEvent('braquage_superette:removeItem')
AddEventHandler('braquage_superette:removeItem', function(source, item, quantity)
    local source = source
...
lib.callback.register('braquage_superette:getPoliceCount', function()
