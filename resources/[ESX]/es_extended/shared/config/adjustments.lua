...
Config.DiscordActivity = {
    appId = 1121146981755138068, -- Discord Application ID,
    assetName = "logo_wind_w_blanc_yt", --image name for the "large" icon.
    assetText = "Wind Studio", -- Text to display on the asset
    buttons = {
        --{ label = "Join Server", url = "fivem://connect/{server_endpoint}" },
        { label = "Discord", url = "https://discord.gg/7SBn6ygS87" },
    },
